# test_firestore_integration.R
cat("🔥 Testing Firestore Integration\n")
...
writeLines(test_script, "test_firestore.py")
cat("📄 Created test_firestore.py\n")

# Run the test
system2(file.path("venv", "Scripts", "python.exe"),
        args = "test_firestore.py")

cat("✅ Firestore test completed!\n")